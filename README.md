...
- **24.06.18** - ( [🔗](https://github.com/100-hours-a-week/seny-til/blob/main/Jun/2024-06-18.md) ${\textsf{\color{#1e90ff}프로젝트}}$ ) 8주차 3번 과제 DB MySQL 연동 완료 및 트랜잭션 구현, 사이드 프로젝트 atomic 디자인패턴 구조화,
- **24.06.17** - ( [🔗](https://github.com/100-hours-a-week/seny-til/blob/main/Jun/2024-06-17.md) ${\textsf{\color{#1ed760}미니플젝}}$ ) 사이드 프로젝트 피그마 디자인 완료, 프론트 서버 세팅, 프론트 netlify 배포
...
- **24.06.14** - ( [🔗](https://github.com/100-hours-a-week/seny-til/blob/main/Jun/2024-06-14.md) ${\textsf{\color{#ff69b4}딥다이브}}$ ) 딥다이브 - @Transactional, '머라카노' 사이드 플젝 시작 + 기획상세 및 디자인
